...
function(enable_sanitizers target_name)
  ...
  if(CMAKE_CXX_COMPILER_ID STREQUAL "GNU" OR CMAKE_CXX_COMPILER_ID MATCHES ".*Clang")
    ...
    message(STATUS "Enable coverage: ${HERMES_COVERAGE}")
    ...
    if(HERMES_COVERAGE)
      ...
      if (lcov_FOUND AND genhtml_FOUND)
        ...
        MESSAGE("Target name" code-coverage-capture-${target_name})

        add_custom_target(code-coverage-capture-${target_name}
          COMMAND
            lcov -c --directory  "${CMAKE_CURRENT_BINARY_DIR}/CMakeFiles/${target_name}.dir/src"
        ...
        add_custom_target(code-coverage-clean-${target_name}
          COMMAND
          lcov --zerocounters
