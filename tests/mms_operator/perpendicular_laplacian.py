...
class GeneralMetric:
    def __init__(self, g11=1.0, g12=0.0, g13=0.0, g22=1.0, g23=0.0, g33=1.0):
...
def Div_a_Grad_perp_f(a, f, metric=identity):
    ...
    div_a_grad_perp_f = (1 / J) * (
        diff(a_grad_perp_f_x, x) + diff(a_grad_perp_f_y, y) + diff(a_grad_perp_f_z, z)
    )
