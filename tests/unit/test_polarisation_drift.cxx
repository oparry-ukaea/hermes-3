...
TEST_F(PolarisationDriftTest, calcDivJdia) {
  ...
  Options state{{"fields", {{"DivJdia", 1.0}}}};
...
TEST_F(PolarisationDriftTest, diamagneticCompression) {
  Options options{{"polarisation_drift", {{"average_atomic_mass", 1.5}}}};
...
TEST_F(PolarisationDriftTest, calcMassDensityBoussinesq) {
  Options options{
      {"polarisation_drift", {{"boussinesq", true}, {"average_atomic_mass", 1.5}}}};
...
TEST_F(PolarisationDriftTest, calcMassDensityNonBoussinesq) {
  Options options{{"polarisation_drift", {{"boussinesq", false}}}};

  PolarisationDrift component("polarisation_drift", options, nullptr);

  Options state{{"species", {{"d+", {{"AA", 2.0}, {"charge", 1.0}, {"density", 3.0}}}}}};
      ...
      {"species",
       {{"d+",
         {{"charge", 1.0},
          ...
          {"pressure", 1.0},
          {"momentum", 1.0}}},
        {"i", {{"charge", 1.0}, {"AA", 2.0}, {"density", 1.0}, {"momentum", 1.0}}},
        {"d", {{"AA", 2.0}}},
        {"d2", {{"charge", 0.0}, {"AA", 4.0}}},
        {"massless", {{"charge", 1.0}}}}}};
