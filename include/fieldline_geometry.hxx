...
private:
  ...
  Field3D lambda_int{
      0.0}; ///< Radial width of the flux tube mapped upstream (lambda_q + 1.64S).
  ...
  Field3D toroidal_magnetic_field{
      0.0}; ///< Toroidal magnetic field strength along the fieldline.
  ...
  Field3D transport_broadening{
      0.0};                    ///< Flux tube broadening due to cross-field transport.
  ...
  Field3D cell_side_area{
      0.0}; ///< Poloidal length of the flux tube times its circumference.
  Field3D cell_volume{
      0.0}; ///< Poloidal length of the flux tube times its circumference and radial width.
};
