...
struct HutchinsonCarbon {
  ...
  static constexpr std::string_view type = "hutchinson_carbon";
};
...
struct Argon_adas {
  BoutReal curve(BoutReal Te) {
    ...
    if (Te >= 1.5 and Te <= 1500) {
      log_out = log_out - 8.45410692e+01 * pow(logT, 0) + 1.57727040e+01 * pow(logT, 1)
                - 1.54264860e+01 * pow(logT, 2) + 1.49409902e+01 * pow(logT, 3)
                - 1.04815113e+01 * pow(logT, 4) + 5.00924595e+00 * pow(logT, 5)
                - 1.60029106e+00 * pow(logT, 6) + 3.29455609e-01 * pow(logT, 7)
                - 4.14036827e-02 * pow(logT, 8) + 2.87063206e-03 * pow(logT, 9)
  ...
  static constexpr std::string_view type = "argon";
};
...
struct Neon_adas {
  BoutReal curve(BoutReal Te) {
    ...
    if (Te >= 2 and Te <= 1000) {
      log_out = log_out - 8.21475117e+01 * pow(logT, 0) + 1.28929854e+01 * pow(logT, 1)
                - 4.74266289e+01 * pow(logT, 2) + 7.45222324e+01 * pow(logT, 3)
                - 5.75710722e+01 * pow(logT, 4) + 2.57375965e+01 * pow(logT, 5)
                - 7.12758563e+00 * pow(logT, 6) + 1.24287546e+00 * pow(logT, 7)
                - 1.32943407e-01 * pow(logT, 8) + 7.97368445e-03 * pow(logT, 9)
  ...
  static constexpr std::string_view type = "neon";
};
...
struct Nitrogen_adas {
  BoutReal curve(BoutReal Te) {
    ...
    if (Te >= 2 and Te <= 500) {
      log_out = log_out - 5.01649969e+01 * pow(logT, 0) - 1.35749724e+02 * pow(logT, 1)
                + 2.73509608e+02 * pow(logT, 2) - 2.92109992e+02 * pow(logT, 3)
                + 1.90120639e+02 * pow(logT, 4) - 7.95164871e+01 * pow(logT, 5)
                + 2.17762218e+01 * pow(logT, 6) - 3.88334992e+00 * pow(logT, 7)
                + 4.34730098e-01 * pow(logT, 8) - 2.77683605e-02 * pow(logT, 9)
  ...
  static constexpr std::string_view type = "nitrogen";
};
...
struct Carbon_adas {
  BoutReal curve(BoutReal Te) {
    ...
    if (Te >= 1 and Te <= 500) {
      log_out = log_out - 7.87837896e+01 * pow(logT, 0) + 1.55326376e+00 * pow(logT, 1)
                + 1.65898194e+01 * pow(logT, 2) - 3.23804546e+01 * pow(logT, 3)
                + 3.12784663e+01 * pow(logT, 4) - 1.74826039e+01 * pow(logT, 5)
                + 5.91393245e+00 * pow(logT, 6) - 1.22974105e+00 * pow(logT, 7)
                + 1.54004499e-01 * pow(logT, 8) - 1.06797106e-02 * pow(logT, 9)
  ...
  static constexpr std::string_view type = "carbon";
};
...
struct Argon_simplified1 {
  BoutReal curve(BoutReal Te) {
    ...
    if (Te < 0.52) {
      ...
      return (2.175237e-31 * (59.98 - Te) + 4.190918e-32 * (Te - 19.72))
             / (59.98 - 19.72);

    } else if (Te >= 59.98 and Te < 3000.00) {
      return (4.190918e-32 * (3000.00 - Te) + 1.226496e-32 * (Te - 59.98))
             / (3000.00 - 59.98);
  ...
  static constexpr std::string_view type = "argon_simplified1";
};
...
struct Argon_simplified2 {
  BoutReal curve(BoutReal Te) {
    ...
    if (Te < 0.52) {
      ...
      return (2.175237e-31 * (59.98 - Te) + 0.000000e+00 * (Te - 19.72))
             / (59.98 - 19.72);
  ...
  static constexpr std::string_view type = "argon_simplified2";
};
...
struct Argon_simplified3 {
  BoutReal curve(BoutReal Te) {
    ...
    if (Te < 0.52) {
      ...
      return (2.175237e-31 * (38.02 - Te) + 0.000000e+00 * (Te - 19.72))
             / (38.02 - 19.72);
  ...
  static constexpr std::string_view type = "argon_simplified3";
};
...
struct Krypton_adas {
  BoutReal curve(BoutReal Te) {
    if (Te >= 2 and Te <= 1500) {
      BoutReal logT = log(Te);
      BoutReal log_out = -2.97405917e+01 * pow(logT, 0) - 2.25443986e+02 * pow(logT, 1)
                         + 4.08713640e+02 * pow(logT, 2) - 3.86540549e+02 * pow(logT, 3)
                         + 2.19566710e+02 * pow(logT, 4) - 7.93264990e+01 * pow(logT, 5)
                         + 1.86185949e+01 * pow(logT, 6) - 2.82487288e+00 * pow(logT, 7)
                         + 2.67070863e-01 * pow(logT, 8) - 1.43001273e-02 * pow(logT, 9)
  ...
  static constexpr std::string_view type = "krypton";
};
...
struct Xenon_adas {
  BoutReal curve(BoutReal Te) {
    if (Te >= 2 and Te <= 1300) {
      BoutReal logT = log(Te);
      BoutReal log_out = +3.80572137e+02 * pow(logT, 0) - 3.05839745e+03 * pow(logT, 1)
                         + 9.01104594e+03 * pow(logT, 2) - 1.55327244e+04 * pow(logT, 3)
                         + 1.75819719e+04 * pow(logT, 4) - 1.38754866e+04 * pow(logT, 5)
                         + 7.90608220e+03 * pow(logT, 6) - 3.32041900e+03 * pow(logT, 7)
                         + 1.03912363e+03 * pow(logT, 8) - 2.42980719e+02 * pow(logT, 9)
                         + 4.22211209e+01 * pow(logT, 10) - 5.36813849e+00 * pow(logT, 11)
                         + 4.84652106e-01 * pow(logT, 12) - 2.94023979e-02 * pow(logT, 13)
  ...
  static constexpr std::string_view type = "xenon";
};
...
struct Tungsten_adas {
  BoutReal curve(BoutReal Te) {
    if (Te >= 1.25 and Te <= 1500) {
      BoutReal logT = log(Te);
      BoutReal log_out = -7.24602210e+01 * pow(logT, 0) - 2.17524363e+01 * pow(logT, 1)
                         + 1.90745408e+02 * pow(logT, 2) - 7.57571067e+02 * pow(logT, 3)
                         + 1.84119395e+03 * pow(logT, 4) - 2.99842204e+03 * pow(logT, 5)
                         + 3.40395125e+03 * pow(logT, 6) - 2.76328977e+03 * pow(logT, 7)
                         + 1.63368844e+03 * pow(logT, 8) - 7.11076320e+02 * pow(logT, 9)
                         + 2.28027010e+02 * pow(logT, 10) - 5.30145974e+01 * pow(logT, 11)
                         + 8.46066686e+00 * pow(logT, 12) - 7.54960450e-01 * pow(logT, 13)
                         - 1.61054010e-02 * pow(logT, 14) + 1.65520152e-02 * pow(logT, 15)
                         - 2.70054697e-03 * pow(logT, 16) + 2.50286873e-04 * pow(logT, 17)
                         - 1.43319310e-05 * pow(logT, 18) + 4.75258630e-07 * pow(logT, 19)
...
struct FixedFractionRadiation : public Component {
  ...
  FixedFractionRadiation(std::string name, Options& alloptions, Solver* UNUSED(solver))
      : Component(name, {readOnly("species:e:{inputs}", Regions::Interior),
    ...
    diagnose =
        options["diagnose"].doc("Output radiation diagnostic?").withDefault<bool>(false);
  ...
  static constexpr std::string_view type_prefix = "fixed_fraction_";
  static constexpr auto type = join_v<type_prefix, CoolingCurve::type>;
  ...
  void transform_impl(GuardedOptions& state) override {
    ...
    radiation = cellAverage(
        [&](BoutReal ne, BoutReal te) {
          ...
          return ne * ni * cooling.curve(te * Tnorm) * radiation_multiplier * Nnorm
...
RegisterComponent<FixedFractionRadiation<HutchinsonCarbon>>
    registercomponentfixedfractionhutchinsonbcarbon;
...
RegisterComponent<FixedFractionRadiation<Nitrogen_adas>>
    registercomponentfixedfractionnitrogen;

RegisterComponent<FixedFractionRadiation<Neon_adas>> registercomponentfixedfractionneon;

RegisterComponent<FixedFractionRadiation<Argon_adas>> registercomponentfixedfractionargon;

RegisterComponent<FixedFractionRadiation<Argon_simplified1>>
    registercomponentfixedfractionargonsimplified1;
...
RegisterComponent<FixedFractionRadiation<Argon_simplified3>>
    registercomponentfixedfractionargonsimplified3;

RegisterComponent<FixedFractionRadiation<Krypton_adas>>
    registercomponentfixedfractionkrypton;

RegisterComponent<FixedFractionRadiation<Xenon_adas>> registercomponentfixedfractionxenon;

RegisterComponent<FixedFractionRadiation<Tungsten_adas>>
    registercomponentfixedfractiontungsten;
} // namespace
