...
private:
  ...
  struct RecycleChannel {
    ...
    Field3D target_recycle_density_source = 0.0; ///< Recycling density source for target recycling
    Field3D target_recycle_energy_source = 0.0;  ///< Recycling energy source for target recycling
    Field3D wall_recycle_density_source = 0.0;   ///< Recycling density source for pfr + sol recycling
    Field3D wall_recycle_energy_source = 0.0;    ///< Recycling energy source for pfr + sol recycling
    Field3D pump_density_source = 0.0;           ///< Recycling density source for pump recycling
    Field3D pump_energy_source = 0.0;            ///< Recycling energy source for pump recycling
  };
